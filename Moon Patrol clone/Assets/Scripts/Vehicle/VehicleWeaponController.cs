...
namespace Vehicle {
    public class VehicleWeaponController : MonoBehaviour {
        ...
        private void VerticalShoot() {
            ...
            var verticalBullet =
                Instantiate(Resources.Load("Prefabs/Vertical_Vehicle_Bullet", typeof(GameObject))) as GameObject;
        ...
        private void HorizontalShoot() {
            ...
            var horizontalBullet =
                Instantiate(Resources.Load("Prefabs/Horizontal_Vehicle_Bullet", typeof(GameObject))) as GameObject;
